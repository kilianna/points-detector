...
%JDK_PATH%\javac -encoding utf8 -cp %FIJI_PATH%\jars\ij-1.*.jar -d build Points_Detector.java Slices_Correction.java Slices_Div.java Colors_Move.java Utils.java NativeTools.java    || goto error
cd build
